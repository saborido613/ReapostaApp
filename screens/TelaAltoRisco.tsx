  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <Text style={styles.riscoAlto}>ALTO</Text>
        ...
        <Text style={styles.textoExplicacao}>
          Seu resultado indica um nível alto de risco, com sinais claros de
          comportamento problemático com apostas.
          {"\n\n"}É importante buscar ajuda e repensar sua relação com o jogo.
          Você não está sozinho — o app oferece acesso a apoio psicológico,
          conteúdos educativos e ferramentas práticas para te ajudar a retomar o
