  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <Text style={styles.riscoAmarelo}>BAIXO</Text>
        ...
        <Text style={styles.textoExplicacao}>
          Seu envolvimento com apostas ainda é considerado leve, mas já existem
          sinais que merecem atenção.
          {"\n\n"}É um ótimo momento para refletir e adotar práticas de jogo
          responsável. Prevenção é sempre o melhor caminho.
        </Text>
